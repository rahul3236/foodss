...
export default class Location extends Component {
  ...
  handlePaginationChange = (event, { activePage} ) => {
    fetch('http://18.234.207.58:5000/product/'+activePage)
    ...
    console.log("COmponent mounting")
        fetch('http://18.234.207.58:5000/product/')
    .then((response) => response.json())
    .then((responseJson) => {
        console.log(responseJson)
 ...
 this.setState({response:res})
  ...
  itemedit = (id) => {
      ...
      fetch('http://18.234.207.58:5000/product/subcatlist', {
        method: 'POST',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
  ...
  handleDelete = (id) => {
      let res=[]
      alert(id)
      fetch('http://18.234.207.58:5000/product/deleteproduct/', {
        method: 'POST',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
